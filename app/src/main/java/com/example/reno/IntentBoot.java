...
public class IntentBoot extends BroadcastReceiver{
    ...
    public void BuildNotification(Context context,Intent intent){
        ...
        wl.acquire();
        String col = intent.getStringExtra("messageType");
        ...
        NotificationCompat.Action BackAction= new NotificationCompat.Action(android.R.drawable.ic_lock_idle_alarm,"VIEW ALRAM",BackPend);
       ...
       //Dismiss Button
        ...
        PendingIntent PendingDismiss= PendingIntent.getService(context,4000000,dismissIntent,PendingIntent.FLAG_UPDATE_CURRENT);
